...
export default async function DetailProduct({
    ...
    return (
        <div className="bg-gradient-to-bl from-teal-700 to-teal-950 max-h-max py-20">
          <div className="bg-white flex flex-col w-3/4 lg:w-1/2 h-max justify-self-center rounded-lg gap-y-4 shadow-md shadow-gray-200/60 px-4 lg:px-8">
